...
const Footer = () => {
  return (
    <div className="pt-32 bg-customSectionBg">
      <div className="mainWidth ">
        <div className="justify-between md:flex md:gap-12">
          <div className=" md:w-1/2 lg:w-1/4 ">
            ...
            <div className="inline-block px-2 py-3 my-6 gap-4 bg-third">
        ...
        <div className="border-t-2 border-sixth pt-6 flex justify-between text-sixth pb-6 text-xs ">
